-- ============================================================
-- Migration: Add created_by_user_id to predictions
-- Allows regular users to create their own questions
-- ============================================================

-- Step 1: Add created_by_user_id column (nullable — existing questions by admins use created_by)
ALTER TABLE predictions
  ADD COLUMN IF NOT EXISTS created_by_user_id UUID REFERENCES auth.users(id) ON DELETE SET NULL;

-- Step 2: Update resolve_prediction_atomic to also return creator info
...
BEGIN
  ...
  -- 🍊 กระสุมส้ม: รวม sponsor_pool ในพูลทัง้หมดกอนหาค่าธรรมเนียม
