...
export default function NumberWarPage() {
  ...
  async function handleBuy(slot: NumberSlot) {
    if (demoMode) {
      ...
      setMessage(`🎮 Demo Mode: จะซื้อเลข ${slot.slot_number} ราคา ${price} coins (กดซื้อจริงจะหัก coins และบันทึกเจ้าของ)`);
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: "12px" }}>
          ทายเลข 0-200 | ซื้อครั้งแรก 10 coins | แย่งซื้อ x2 ทุกครั้ง | ชนะตามคะแนนทีม
        </p>
      </div>
      ...
      >
        <div>
          ...
          <div style={{ fontSize: "11px", color: "var(--muted)" }}>
            {demoMode
              ? "ทดลองเล่นแบบไม่บันทึกข้อมูล (Demo Coins: " + demoCoins + ")"
              : "เล่นจริง หัก coins จริง"}
          </div>
        </div>
        <button
        ...
        {slots.map((slot) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontSize: "9px", color: "var(--muted)", marginTop: "2px" }}>{price} coins</div>
              {slot.owner_id && (
                <div
                  style={{
                    fontSize: "8px",
            ...
            <div style={{ display: "grid", gap: "8px", marginBottom: "16px" }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <span style={{ color: "var(--yellow)", fontWeight: "700" }}>
                  {selectedSlot.owner_id ? selectedSlot.current_price * 2 : selectedSlot.current_price} coins
                </span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
